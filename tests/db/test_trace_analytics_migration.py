...
def test_postgres_rollup_ids_use_identity(model):
    ddl = str(sa.schema.CreateTable(model.__table__).compile(dialect=postgresql.dialect()))
        ...
        [
            ...
            },
            {
                ...
                "value": json.dumps({
                    ...
                    TokenUsageKey.CACHE_CREATION_INPUT_TOKENS_ABOVE_1HR: 4,
                }),
            },
            {
                "request_id": "trace-explicit",
        ...
        with engine.connect() as conn:
            traces = conn.execute(
                sa.text(
                    ...
                    "cache_creation_input_tokens_above_1hr, input_cost, output_cost, total_cost "
    ...
    try:
        ...
        with engine.connect() as conn:
            ...
            assert token_usage == (
                ...
                '"cache_creation_input_tokens_above_1hr": 4}'
            )
            spans = _table(conn, "spans")
